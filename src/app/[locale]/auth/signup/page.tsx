  ...
  return (
    <div className="flex flex-col gap-10 sm:w-[300px]">
      <div className="flex flex-col gap-2">
        <h1 className="font-medium text-lg uppercase">{auth('screens.signUp.title')}</h1>
        <p className="text-muted-foreground text-sm leading-none">{auth('screens.signUp.subtitle')}</p>
      </div>
      <div className="flex flex-col gap-2">
